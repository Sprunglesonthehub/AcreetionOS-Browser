...
var gLibrewolfPane = {
  ...
  init() {
    ...
    setBoolSyncListeners(
      "acreetionos_browser-ipv6-checkbox",
    ...
    setBoolSyncListeners(
      "acreetionos_browser-sync-checkbox",
    ...
    setEventListener("acreetionos_browser-open-profile", "command", openProfileDirectory);
    // Set event listener on open about:config button
    setEventListener("acreetionos_browser-config-link", "click", openAboutConfig);

    // Notify observers that the UI is now ready
    Services.obs.notifyObservers(window, "acreetionos_browser-pane-loaded");
  },
};
